// Hotel Operations Authentication System - Local Version
...
async function initSupabase() {
    try {
        ...
        // Use a simple check for Supabase availability
...
// Mock Supabase client for testing when CDN is blocked
...
// Try to load Supabase from CDN, fallback to mock
function loadSupabase() {
    ...
    script.onerror = () => {
        console.warn('Failed to load Supabase from CDN, using mock');
        initApp();
    };
    ...
    setTimeout(() => {
        if (!window.supabase) {
            console.warn('Supabase load timeout, using mock');
            initApp();
        }
    }, 3000);
